...
export const reportMarkdown = `# How Accurate Is Polymarket, Really?
...
These observations are **not independent**. Multiple tokens from the same question move together. The effective sample size is closer to the 13,160 distinct questions than the 68,888 token count, so the statistical confidence these sample sizes imply is overstated.
...
**Reproducibility**: All queries are in the [queries/](https://github.com/maksymsherman/allium-polymarket-analysis/tree/main/queries) directory. This analysis builds on McCullough's [original Dune dashboard](https://dune.com/alexmccullough/how-accurate-is-polymarket).
`;

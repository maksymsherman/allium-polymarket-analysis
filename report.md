...
**Reproducibility**: All queries in the [`queries/`](queries/) directory. Inspired by McCullough's [original Dune dashboard](https://dune.com/alexmccullough/how-accurate-is-polymarket).
